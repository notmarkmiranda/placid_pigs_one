...
users = [
  ...
  { 
    ...
    picks: [
      ...
      { team_id: all_teams["LAD"].id, date: Date.new(2020, 7, 31), game_week_id: GameWeek.by_date(season, Date.new(2020, 7, 31)).id },
      { team_id: all_teams["KC"].id, date: Date.new(2020, 8, 1), game_week_id: GameWeek.by_date(season, Date.new(2020, 8, 1)).id },
      ...
      { team_id: all_teams["WAS"].id, date: Date.new(2020, 8, 7), game_week_id: GameWeek.by_date(season, Date.new(2020, 8, 7)).id },
      { team_id: all_teams["LAA"].id, date: Date.new(2020, 8, 8), game_week_id: GameWeek.by_date(season, Date.new(2020, 8, 8)).id },
      { team_id: all_teams["KC"].id, date: Date.new(2020, 8, 9), game_week_id: GameWeek.by_date(season, Date.new(2020, 8, 9)).id }
    ]
  },
  { 
    ...
    picks: [
      ...
      { team_id: all_teams["KC"].id, date: Date.new(2020, 8, 2), game_week_id: GameWeek.by_date(season, Date.new(2020, 8, 2)).id },
  ...
  { 
    ...
    picks: [
      ...
      { team_id: all_teams["KC "].id, date: Date.new(2020, 7, 30), game_week_id: GameWeek.by_date(season, Date.new(2020, 7, 30)).id },
      { team_id: all_teams["STL"].id, date: Date.new(2020, 7, 31), game_week_id: GameWeek.by_date(season, Date.new(2020, 7, 31)).id },
  ...
  { 
    ...
    picks: [
      ...
      { team_id: all_teams["KC"].id, date: Date.new(2020, 7, 25), game_week_id: GameWeek.by_date(season, Date.new(2020, 7, 25)).id },
      { team_id: all_teams["MIL"].id, date: Date.new(2020, 7, 26), game_week_id: GameWeek.by_date(season, Date.new(2020, 7, 26)).id },
